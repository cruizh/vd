...
\begin{example}
 \(\mathcal{M}_{n\times n}(\mathbb{R})(\cong)_{\varphi}\mathbb{R}^{n^{2}}\) con
\(\operatorname{det}:\mathbb{R}^{n^{2}}\rightarrow\mathbb{R}\) es un polinomio y por ello
función continua. \(U=(\operatorname{det})^{-1}(\mathbb{R}\textbackslash\{0\})\) abto. De
hecho, \(U\equiv\operatorname{GL}(n,\mathbb{R})\) por la biyección \(\varphi\) de 5.
\end{example}

\begin{example}
\(S^{1}\subseteq \mathbb{R}^{2}\) es \(2\)-variedad con un atlas formado por dos
proyecciones estereográficas.
\end{example}

\begin{example}
De hecho \(S^{n}\subseteq\mathbb{R}^{n+1}\) tiene un atlas con 2 cartas (nos apoyamos en la proyección
estereográfica):

\vline

Sea \(U_{+}=\{(x_{1},\cdots,x_{n+1})=x:x\neq
(0,\cdots,1)\}\overset{\varphi_{+}}{\rightarrow}\mathbb{R}^{n}\) tal que \[
\varphi_{+}(x_{1},x_{n+1})=(\frac{x_{1}}{1-x_{n+1}},\cdots,\frac{x_{n}}{1-x_{n+1}})\]
y \[
\varphi_{+}^{-1}(y_{1},\cdots,y_{n})=(\frac{2y_{1}}{1+\Norm{y}^{2}},\cdots,\frac{2y_{n}}{1+\Norm{y}^{2}},\frac{\Norm{y}^{2}-1}{1+\Norm{y}^{2}})\] 
...
\varphi_{-}(x_{1},x_{n+1})=(\frac{x_{1}}{1+x_{n+1}},\cdots,\frac{x_{n}}{1+x_{n+1}})\]
y \[
\varphi_{-}^{-1}(y_{1},\cdots,y_{n})=(\frac{2y_{1}}{1+\Norm{y}^{2}},\cdots,\frac{2y_{n}}{1+\Norm{y}^{2}},\frac{1-\Norm{y}^{2}}{1+\Norm{y}^{2}})\]

\vline

Por lo tanto, \(\mathcal{A}=\{(U_{+},\varphi_{+}),(U_{-},\varphi_{-})\}\) es un
atlas de \(S^{n}\subseteq\mathbb{R}^{n}\), pues se comprueba fácilmente que
