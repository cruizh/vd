...
\item[Péndulo plano:] El espacio de configuraciones de este sistema es la
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[scale=0.6]{intro-fig10b.pdf} % NEED GRAPHICS
    \caption{}
    \label{fig10b}
  \end{figure}
...
\item[Péndulo múltiple:] Dados $n$ péndulos simples (planos o esféricos)
  ...
  \begin{figure}[ht]
    \centering
    \subfloat{\includegraphics[scale=0.6]{intro-fig20.pdf}}\qquad %% TFB % NEED GRAPHICS
    \subfloat{\includegraphics[scale=0.4]{intro-fig30.pdf}} %% TFB % NEED GRAPHICS
    \caption{}
    \label{fig20y30}
  \end{figure}
  ...
  \begin{figure}[ht]
    \centering
    \subfloat{\includegraphics[scale=0.6]{intro-fig40.pdf}}\qquad %% TFB % NEED GRAPHICS
    \subfloat{\includegraphics[scale=0.9]{intro-fig50d.pdf}} %% TFB % NEED GRAPHICS
...
\item[Triángulo rígido:] Sea $S$ el sistema mecánico formado por el triángulo
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{intro-fig240.pdf} %%TFB % NEED GRAPHICS
    \caption{}
    \label{fig240}
  \end{figure}
