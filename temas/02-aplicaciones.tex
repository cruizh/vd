...
\begin{proof}
    ...
    si llamamos \(w_i = (1-t_i) x -t_{i} y\) llegamos a
		...
		\]
		Si aplicamos el apartado \((2)\) del \cref{lem:prop-med-var} podemos suponer que \(A\subseteq \Gamma\). Si \(A\subseteq \bigcup_{s=1}^\infty C_s\) siendo \(C_s\) cubos de volumen \(\sqrt{s}\) con \(\sum_{s=1}^{\infty}v_s <\dfrac{\epsilon}{K^n}\)\\
